...
public class ParserChunker2MatcherProcessorTest extends TestCase {
	...
	public void testGroupedPhrasesFormer() {
		...
		assertEquals(
				...
				// "[[NP [PRP$-your NN-town NN-office CC-or NN-city NN-hall ],
				// NP [PRP$-your NN-town NN-doesn NN-t ], NP [DT-an NN-office ],
				// NP [DT-the NN-town NN-clerk CC-or DT-a NNP-Selectman ], NP
				// [DT-a NNP-Selectman ], NP [PRP-them IN-that PRP-you ], NP
				// [PRP-you ], NP [DT-a CD-1040 NN-tax NN-form ], NP [PRP-I ],
				// NP [DT-the NNS-Taxes IN-on PRP$-my NNP-House WP-What MD-Can
				// PRP-I ], NP [PRP$-my NNP-House WP-What MD-Can PRP-I ], NP
				// [WP-What MD-Can PRP-I ], NP [PRP-I ], NP [NNP-Pine NNP-Tree
				// NNP-Legal ]], [VP [VBP-do RB-I VB-apply ], VP [VB-Go TO-to
				// PRP$-your NN-town NN-office CC-or NN-city NN-hall ], VP
				// [VBP-have DT-an NN-office ], VP [VB-ask DT-the NN-town
				// NN-clerk CC-or DT-a NNP-Selectman ], VP [VB-Tell PRP-them
				// IN-that PRP-you ], VP [VBP-need DT-a CD-1040 NN-tax NN-form
				// ], VP [MD-Can VB-t VB-Pay DT-the NNS-Taxes IN-on PRP$-my
				// NNP-House WP-What MD-Can PRP-I ], VP [VB-Do NNP-Pine NNP-Tree
				// NNP-Legal ]], [PP [TO-to PRP$-your NN-town NN-office CC-or
				// NN-city NN-hall ], PP [IN-on PRP$-my NNP-House WP-What MD-Can
				// PRP-I ]], [], [SENTENCE [WRB-Where VBP-do RB-I VB-apply ],
				// SENTENCE [VB-Go TO-to PRP$-your NN-town NN-office CC-or
				// NN-city NN-hall ], SENTENCE [IN-If PRP$-your NN-town NN-doesn
				// NN-t VBP-have DT-an NN-office VB-ask DT-the NN-town NN-clerk
				// CC-or DT-a NNP-Selectman ], SENTENCE [VB-Tell PRP-them
				// IN-that PRP-you VBP-need DT-a CD-1040 NN-tax NN-form ],
				// SENTENCE [PRP-I MD-Can VB-t VB-Pay DT-the NNS-Taxes IN-on
				// PRP$-my NNP-House WP-What MD-Can PRP-I VB-Do NNP-Pine
				// NNP-Tree NNP-Legal ]]]",
				res.toString());
		...
		res = parser.formGroupedPhrasesFromChunksForSentence(
	...
	public void testRelevanceAssessm() {
		...
		String phrase1 = "Its classy design and the Mercedes name make it a very cool vehicle to drive. "
				+ "The engine makes it a powerful car. " + "The strong engine gives it enough power. "
				+ "The strong engine gives the car a lot of power.";
		String phrase2 = "This car has a great engine. " + "This car has an amazingly good engine. "
	...
	public void testCompareRelevanceAssessmWithBagOfWords() {
		parser = ParserChunker2MatcherProcessor.getInstance();
		// we first demonstrate how similarity expression for DIFFERENT cases
		// have
		...
		System.out.println("MatchScore is adequate ( = " + matchScore + ") and bagOfWordsScore = " + bagOfWordsScore
				+ " is too high");

		// we now demonstrate how similarity can be captured by POS and cannot
		// be
