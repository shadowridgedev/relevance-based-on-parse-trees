...
public class ParseTreeChunkTest extends TestCase {
	...
	public void test() {
		...
		ch1 = new ParseTreeChunk("NP", new String[] { "great", "unsecured", "loan", "deals" },
				new String[] { "JJ", "JJ", "NN", "NNS" });
		...
		ch1 = new ParseTreeChunk("NP", new String[] { "great", "unsecured", "loan", "of", "jambo" },
				new String[] { "JJ", "JJ", "NN", "IN", "NN" });
		...
		ch2 = new ParseTreeChunk("NP", new String[] { "I", "like", "it", "because", "it", "is", "loud" },
				new String[] { "NP", "IN", "NP", "IN", "NP", "VBZ", "ADJP" });
		...
		ch2 = new ParseTreeChunk("VP", new String[] { "run", "to", "the", "tiger", "zoo" },
				new String[] { "VBP", "TO", "DT", "NN", "NN" });
		assertEquals(parseTreeMatcher.generalizeTwoGroupedPhrasesDeterministic(ch1, ch2).toString(),
				"[ [VBP-* TO-to ],  [VB-run IN-* NP-zoo ],  [NP-tigers ]]");

		ch1 = new ParseTreeChunk("VP", new String[] { "love", "to", "run", "around", "tigers", "zoo" },
				new String[] { "VBP", "TO", "VB", "IN", "NP", "NP" });
		ch2 = new ParseTreeChunk("VP", new String[] { "run", "to", "the", "tiger", "zoo" },
				new String[] { "VBP", "TO", "DT", "NN", "NN" });
		assertEquals(parseTreeMatcher.generalizeTwoGroupedPhrasesDeterministic(ch1, ch2).toString(),
				"[ [VBP-* TO-to ],  [VB-run IN-* NP-tigers NP-zoo ]]");
		ch1 = new ParseTreeChunk("VP", new String[] { "run", "around", "tigers", "zoo" },
				new String[] { "VB", "IN", "NP", "NP" });

		ch2 = new ParseTreeChunk("NP", new String[] { "run", "to", "the", "tiger", "zoo" },
				new String[] { "VBP", "TO", "DT", "NN", "NN" });
