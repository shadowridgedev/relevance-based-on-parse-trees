...
public class GeneralizationListReducerTest extends TestCase {
	...
	public void test() {
		ParseTreeChunk ch1 = new ParseTreeChunk("VP", new String[] { "run", "around", "tigers", "zoo" },
				new String[] { "VB", "IN", "NP", "NP" });

		ParseTreeChunk ch2 = new ParseTreeChunk("NP", new String[] { "run", "around", "tigers" },
				new String[] { "VB", "IN", "NP", });

		ParseTreeChunk ch3 = new ParseTreeChunk("NP", new String[] { "the", "tigers" }, new String[] { "DT", "NP", });

		ParseTreeChunk ch4 = new ParseTreeChunk("NP", new String[] { "the", "*", "flying", "car" },
				new String[] { "DT", "NN", "VBG", "NN" });
