...
public class FrameQueryBasedIExtractor {
	...
	public static void main(String[] args) {
		...
		extractor.buildPTTemplates(texts);
		List<GeneralizationResult> res = extractor.doIEforPT(
				"I had to use crampons to cross snow slopes without an ice axe in late afternoon. However in summer I do not feel it was dangerous crossing the snow.");
		...
		res = extractor
				.doIE("Mary Jones send her Canada prisoner id number 666666666. Mary Stewart hid her Mexico cook id number 666666666 . Robin Hood mentioned his UK fisher id  2345."
