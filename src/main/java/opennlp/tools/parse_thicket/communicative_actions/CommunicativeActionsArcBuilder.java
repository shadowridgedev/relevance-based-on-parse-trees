...
public class CommunicativeActionsArcBuilder implements IGeneralizer<Pair<String, Integer[]>> {
	...
	public Pair<String, Integer[]> findCAInSentence(List<ParseTreeNode> sentence) {
		for (ParseTreeNode node : sentence) {
			for (Pair<String, Integer[]> ca : commActionsAttr) {
				...
				// canonical form lemma is a sub-string of an actual form in
				// parseTreeNode
	...
	public List<Pair<String, Integer[]>> generalize(Object o1, Object o2) {
		...
		if (ca1.equals(ca2)) {
			...
			Integer[] res = new CommunicativeActionsAttribute().generalize(caP1.getSecond(), caP2.getSecond()).get(0);
	...
	/*
	 * Pair<String, Integer[]>[] commActionsAttrAr = new Pair<String,
	 * Integer[]>[] { new Pair<String, Integer[]>("agree", new Integer[]{ 1, -1,
	 * -1, 1, -1}), new Pair<String, Integer[]>("accept", new Integer[]{ 1, -1,
	 * -1, 1, 1}), new Pair<String, Integer[]>("explain", new Integer[]{ 0, -1,
	 * 1, 1, -1}), new Pair<String, Integer[]>("suggest", new Integer[]{ 1, 0,
	 * 1, -1, -1}), new Pair<String, Integer[]>("bring attention", new
	 * Integer[]{ 1, 1, 1, 1, 1}), new Pair<String, Integer[]>("remind", new
	 * Integer[]{ -1, 0, 1, 1, 1}), new Pair<String, Integer[]>("allow", new
	 * Integer[]{ 1, -1, -1, -1, -1}), new Pair<String, Integer[]>("try", new
	 * Integer[]{ 1, 0, -1, -1, -1}), new Pair<String, Integer[]>("request", new
	 * Integer[]{ 0, 1, -1, 1, 1}), new Pair<String, Integer[]>("understand",
	 * new Integer[]{ 0, -1, -1, 1, -1}), new Pair<String, Integer[]>("inform",
	 * new Integer[]{ 0, 0, 1, 1, -1}), new Pair<String, Integer[]>("confirm",
	 * new Integer[]{ 0, -1, 1, 1, 1}), new Pair<String, Integer[]>("ask", new
	 * Integer[]{ 0, 1, -1, -1, -1}), new Pair<String, Integer[]>("check", new
	 * Integer[]{ -1, 1, -1, -1, 1}), new Pair<String, Integer[]>("ignore", new
	 * Integer[]{ -1, -1, -1, -1, 1}), new Pair<String, Integer[]>("convince",
	 * new Integer[]{ 0, 1, 1, 1, -1}), new Pair<String, Integer[]>("disagree",
	 * new Integer[]{ -1, -1, -1, 1, -1}), new Pair<String, Integer[]>("appeal",
	 * new Integer[]{ -1, 1, 1, 1, 1}), new Pair<String, Integer[]>("deny", new
	 * Integer[]{ -1, -1, -1, 1, 1}), new Pair<String, Integer[]>("threaten",
