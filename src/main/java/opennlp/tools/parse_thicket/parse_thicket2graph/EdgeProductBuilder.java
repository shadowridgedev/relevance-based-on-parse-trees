...
public class EdgeProductBuilder {
	...
	public Graph<ParseGraphNode[], DefaultEdge> buildEdgeProduct(Graph<ParseGraphNode, DefaultEdge> g1,
			Graph<ParseGraphNode, DefaultEdge> g2) {
		Graph<ParseGraphNode[], DefaultEdge> gp = new SimpleGraph<ParseGraphNode[], DefaultEdge>(DefaultEdge.class);
	...
	public Collection<Set<ParseGraphNode[]>> getMaximalCommonSubgraphs(Graph<ParseGraphNode[], DefaultEdge> g) {
		BronKerboschCliqueFinder<ParseGraphNode[], DefaultEdge> finder = new BronKerboschCliqueFinder<ParseGraphNode[], DefaultEdge>(
				g);
	...
	private boolean bothAjacentOrNeitherAdjacent(ParseGraphNode[] prodVertexI, ParseGraphNode[] prodVertexJ) {
		List<ParseGraphNode> prodVertexIlist = new ArrayList<ParseGraphNode>(Arrays.asList(prodVertexI));
		List<ParseGraphNode> prodVertexJlist = new ArrayList<ParseGraphNode>(Arrays.asList(prodVertexJ));
	...
	public static void main(String[] args) {
		...
		Collection<Set<ParseGraphNode[]>> col = b.assessRelevanceViaMaximalCommonSubgraphs(
