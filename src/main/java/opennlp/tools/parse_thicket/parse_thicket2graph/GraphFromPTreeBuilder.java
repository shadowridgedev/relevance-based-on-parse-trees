...
public class GraphFromPTreeBuilder {
	...
	private Graph<ParseGraphNode, DefaultEdge> buildGGraphFromTree(Tree tree) {
		Graph<ParseGraphNode, DefaultEdge> g = new SimpleGraph<ParseGraphNode, DefaultEdge>(DefaultEdge.class);
	...
	/*
	 * private static void navigateChildren(PTTree[] trChildren, int indent,
	 * boolean parentLabelNull, boolean onlyLabelValue,
	 * List<LabeledScoredTreeNode> phrases) { boolean firstSibling = true;
