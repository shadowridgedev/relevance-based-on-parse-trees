...
public class PT2ExtendedTreeForestBuilder {
	...
	private static final String modelFileName = "model.txt", trainingFileName = "training.txt";
	...
	public void formPosNegTrainingSet(String pos, String neg, String path) {
		List<String[]> list = formTrainingSetFromText(pos, true), negList = formTrainingSetFromText(neg, false);
		list.addAll(negList);
	...
	public static void main(String[] args) {
		...
		builder.classifySentences(
				"Iran refuses Iraq's offer to end its conflict with UN. Iran passes a resolution prohibiting UN from doing second"
