...
public class ParseCorefsBuilder {
	...
	public List<WordWordInterSentenceRelationArc> buildCAarcs(List<List<ParseTreeNode>> nodesThicket) {
		List<WordWordInterSentenceRelationArc> arcs = new ArrayList<WordWordInterSentenceRelationArc>();

		for (int sentI = 0; sentI < nodesThicket.size(); sentI++) {
			for (int sentJ = sentI + 1; sentJ < nodesThicket.size(); sentJ++) {
				List<ParseTreeNode> sentenceI = nodesThicket.get(sentI), sentenceJ = nodesThicket.get(sentJ);
				...
				ArcType arcType = new ArcType("ca", caGen.getFirst().toString() + printNumArray(caGen.getSecond()), 0,
						0);
				WordWordInterSentenceRelationArc arc = new WordWordInterSentenceRelationArc(
						new Pair<Integer, Integer>(sentI, indexCA1), new Pair<Integer, Integer>(sentJ, indexCA2),
						caI.getFirst(), caJ.getFirst(), arcType);
				arcs.add(arc);
	...
	public static void main(String[] args) throws IOException {
		...
		ParseThicket th = builder.buildParseThicket(
...
/*
 * [<sent=1-word=1..Iran> ===> <sent=3-word=9..Iran>, <sent=1-word=1..Iran> ===>
 * <sent=4-word=1..Iran>, <sent=1-word=1..Iran> ===> <sent=4-word=4..its>,
 * <sent=1-word=1..Iran> ===> <sent=4-word=17..it>, <sent=3-word=9..Iran> ===>
 * <sent=4-word=1..Iran>, <sent=3-word=9..Iran> ===> <sent=4-word=4..its>,
 * <sent=3-word=9..Iran> ===> <sent=4-word=17..it>, <sent=4-word=1..Iran> ===>
 * <sent=4-word=4..its>, <sent=4-word=1..Iran> ===> <sent=4-word=17..it>,
 * <sent=4-word=4..its> ===> <sent=4-word=17..it>, <sent=1-word=6..UN> ===>
 * <sent=2-word=1..UN>, <sent=1-word=5..the UN proposal> ===>
 * <sent=1-word=10..its>, <sent=1-word=5..the UN proposal> ===>
 * <sent=1-word=13..its>, <sent=1-word=10..its> ===> <sent=1-word=13..its>,
 * <sent=1-word=16..nuclear weapons> ===> <sent=3-word=14..nuclear weapons>,
 * <sent=2-word=1..UN nuclear watchdog> ===> <sent=2-word=11..its>]
 * 
 * [[[1]Iran:NNP>LOCATION, [2]refuses:VBZ>O, [3]to:TO>O, [4]accept:VB>O,
 * [5]the:DT>O, [6]UN:NNP>ORGANIZATION, [7]proposal:NN>O, [8]to:TO>O,
 * [9]end:VB>O, [10]its:PRP$>O, [11]dispute:NN>O, [12]over:IN>O, [13]its:PRP$>O,
 * [14]work:NN>O, [15]on:IN>O, [16]nuclear:JJ>O, [17]weapons:NNS>O, [18].:.>O],
 * 
 * [[1]UN:NNP>ORGANIZATION, [2]nuclear:JJ>O, [3]watchdog:NN>O, [4]passes:VBZ>O,
 * [5]a:DT>O, [6]resolution:NN>O, [7]condemning:VBG>O, [8]Iran:NNP>LOCATION,
 * [9]for:IN>O, [10]developing:VBG>O, [11]its:PRP$>O, [12]second:JJ>ORDINAL,
 * [13]uranium:NN>O, [14]enrichment:NN>O, [15]site:NN>O, [16]in:IN>O,
 * [17]secret:NN>O, [18].:.>O],
 * 
 * [[1]A:DT>O, [2]recent:JJ>O, [3]IAEA:NNP>ORGANIZATION, [4]report:NN>O,
 * [5]presented:VBD>O, [6]diagrams:NNS>O, [7]that:WDT>O, [8]suggested:VBD>O,
 * [9]Iran:NNP>LOCATION, [10]was:VBD>O, [11]secretly:RB>O, [12]working:VBG>O,
 * [13]on:IN>O, [14]nuclear:JJ>O, [15]weapons:NNS>O, [16].:.>O],
 * 
 * [[1]Iran:NNP>LOCATION, [2]envoy:NN>O, [3]says:VBZ>O, [4]its:PRP$>O,
 * [5]nuclear:JJ>O, [6]development:NN>O, [7]is:VBZ>O, [8]for:IN>O,
 * [9]peaceful:JJ>O, [10]purpose:NN>O, [11],:,>O, [12]and:CC>O, [13]the:DT>O,
 * [14]material:NN>O, [15]evidence:NN>O, [16]against:IN>O, [17]it:PRP>O,
 * [18]has:VBZ>O, [19]been:VBN>O, [20]fabricated:VBN>O, [21]by:IN>O,
 * [22]the:DT>O, [23]US:NNP>LOCATION, [24].:.>O]]
 */
