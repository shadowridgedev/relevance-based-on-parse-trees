...
public class GoogleAutoCompleteQueryRunner {
	...
	private static String searchRequest = "http://google.com/complete/search?q=", suffix = "&output=toolbar";
	...
	public static String handleCamelCases(String input) {
		String s = input.replaceAll("([a-z,A-Z][a-z])([A-Z][a-z])", "$1 $2").replaceAll("([a-z,A-Z][a-z])([A-Z][a-z])",
				"$1 $2");
	...
	public static void main(String[] args) {
		...
		String[] tests = new String[] { "SharingInviteNotification", "SharedByMeSortingOptions",
				"SharedByMeCurrentSortingOption", "GroupedPrivatelySharedByMe", "StorageMeter", "RecentActivities",
				"StorageMeter", "SharingInviteNotification", "RecentActivities", "ImporterSuggestionsPrefABC", "WSItem",
				"SharingInviteNotification", "UserDesktopDevices", "RootFoldersPaginated", "SharingInviteNotification",
		...
		List<String> res = runner.getAutoCompleteExpression("commentcount");
