...
public class WebSearchEngineResultsScraper {
	...
	private static List<HitBase> extractSearchResultFromPage(String content) {
		...
		for (String u : srchResArea) {
			try {
				...
				// problem parsing SERP page; source - specific problem so we
	...
	public Set<String> getURLsForWebDomainIterations(String domain) {
		List<String> results = new ArrayList<String>();
		List<String> res = extractURLsFromPage(fetchPageSearchEngine(formRequestURL(domain)), domain);
		for (String r : res)
	...
	public List<HitBase> runSearch(String query) {
		...
		/*
		 * Actual external web search is commented out try { String serp =
		 * fetchPageSearchEngine(formRequestURL(query)); hits =
		 * extractSearchResultFromPage(serp);
		 * 
		 * } catch (Exception e) {
		 * 
		 * }
	...
	private void buildCache() {
		cachedSearchEngineData.put("remember+to+buy+milk+tomorrow+for+details", new String[][] {
				{ "Remember The Milk - Services / Remember The Milk for Email",
						"to Remember The Milk just by sending an email to a special address. Read this page to learn all the details, and if you have any questions or run into any .... email address] Buy birthday present for Mike today Pay the phone bill tomorrow Make" },
				...
				{ "Remember The Milk - Services / Remember The Milk for iPad / FAQ",
						"How do I get rid of some cards? If you're finished viewing a task. Can I share lists with other Remember The Milk users? While the app doesn't currently ..." },
				{ "Get Organized with Remember the Milk",
						"Let's take a closer look at Remember the Milk's basic and more ... tabs based on when they're due: today, tomorrow, and overdue. Once you do, on the right hand side, a task box will contain editable details about that task." }, });
		cachedSearchEngineData.put("remember+to+buy+milk+tomorrow+from+trader+joes", new String[][] {
				{ "What I buy at Trader Joe's - 100 Days of Real Food",
						" First of all, I don't do all my shopping at Trader Joe's (I get produce, dairy, and other items at .... I use the olive oil, I buy my milk and eggs from them. ... Remember I'm talking raw non-homogenized which is even more delicate." },
				...
				{ "BPA-Free Versions of Popular Foods | Mark's Daily Apple",
						"Here's a list of BPA-free coconut milk, fish, pumpkin, and tomatoes. ... and some (like Trader Joe's) don't even put the label on their products. .... but just remember to check with the supplier before making your purchase. ..... Polls go up tomorrow! http://t.co/aOa2Bsf5 2 days ago; Contest Poll: 2012 Primal" },
				{ "Trader Joes Opens in Plano TX Tomorrow",
						"I love their unsweetened vanilla almond milk! .... I love Trader Joes, and will go out of my way to stop at the one in Santa Fe, NM every time I go" },
				{ "My Favorite Trader Joe's Pantry Items",
						"Because I'm somewhat obsessed with shopping at Trader Joe's, people always ..... See you tomorrow night! .... I bake with the almond meal often and buy the fresh almond milk (blue container), .... I remember I used to get excited to go shopping at the mall, now I have those same feelings towards TJ's." }, });
		cachedSearchEngineData.put("remember+to+buy+milk+tomorrow+from+3+to+jones", new String[][] {
				...
				{ "How to get weed out of your system Fast",
						"Once you get home you are going to immidiatly start drinking the .... for four hours... remember no toxins 48 hours before and no alcohol .... Robert Jones 2 years ago ... this month. what are my chances of passing my test tomorrow? ..... I can't drink milk nor any juices because of my hyperacidity (GERD)." },
				{ "DoubleJones Blog - tidbits of love, life, laughter, and food",
						"It's sometimes hard to function and hard to want to get out of bed ... Posted in baby amelia | 3 Comments » ... I realized that time has gotten away from me, for tomorrow Amelia would have been four weeks old. ... by now, and hopefully, had become an accomplished milk-cow. .... And then I remembered." },
		...
		cachedSearchEngineData.put("remember+to+buy+milk+tomorrow+from+for+d+jones", new String[][] {
				{ "djones - Rock Island/Milan School District #41",
						"Item 361 - 380 – Profile picture of djones. djones. @djones active 6 months, 3 weeks ago ... There are many buy one, get one free offers for area restaurants, museums, zoo, sporting events, etc. ... Vicki Todd wrote a new blog post: PLEASE REMEMBER… ... NOTE: although we collect Swiss Valley milk caps and Campbell's" },
				{ "D-Jones (dcomplex12) on Twitter",
						"D-Jones. @dcomplex12. Just tryna take over the World...Nothing Major. #TeamGNATION SALUTE!!! CST- Stamford · http://Www.facebook.com/dcomplex12 " },
		...
		cachedSearchEngineData.put("How+can+I+pay+tax+on+my+income+abroad", new String[][] {
				...
				{ "Do I have to pay US taxes when I work abroad?",
						"Even if you avoid U.S. income tax, you will likely pay some form of income tax to the ... My son is working overseas and pays all taxes and health insurance there." },
				...
				{ "U.S. Citizens Living Abroad Taxes: Frequently Asked Questions",
						"For the United States income tax return, you will have several options available to you regarding claiming a .... My employer withheld the taxes from my pay." },
				{ "Going to Work Abroad - Revenue Commissioners",
						"A guide to Irish income tax and capital gains tax liability based on some commonly ... In general, tax is deducted from your salary through what is known as the Pay As You Earn (PAYE) ..... What happens if my income is also taxable abroad?" },
				{ "Tax on overseas income : Directgov - Money, tax and benefits",
						"If you live in the UK permanently you'll pay tax on overseas income. If you live here temporarily, you'll normally pay tax only on overseas income you bring into" },
		...
		cachedSearchEngineData.put("Can+I+estimate+what+my+income+tax+would+be+by+using+my+last+pay", new String[][] {
				...
				{ "IRS Withholding Calculator",
						"You can use your results from the calculator to help fill out the form. Who Can Benefit From The ... and deductions, who would prefer to have tax on that income withheld from their paychecks rather than make periodic separate payments through the estimated tax procedures" },
