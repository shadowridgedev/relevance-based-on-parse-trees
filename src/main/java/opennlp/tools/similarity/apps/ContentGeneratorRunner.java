...
public class ContentGeneratorRunner {
	public static void main(String[] args) {
		...
		try {
			...
			try {
				s.sendMail("smtp.live.com", "bgalitsky@hotmail.com", "borgalor",
...
/*
 * C:\stanford-corenlp>java -Xmx1g -jar pt.jar albert+einstein
 * bgalitsky@hotmail.com C:/stanford-corenlp/src/test/resources
 * 
 * http://173.255.254.250:8983/solr/contentgen/?q=albert+einstein&email=
 ...
 * lib&stepsNum=20&searchResultsNum=100&relevanceThreshold=0.5&lang=es-US&
 * bingKey=e8ADxIjn9YyHx36EihdjH/tMqJJItUrrbPTUpKahiU0=
 */
