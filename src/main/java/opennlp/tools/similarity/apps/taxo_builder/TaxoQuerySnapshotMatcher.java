...
public class TaxoQuerySnapshotMatcher {
	...
	/**
	 * Can be used to generate scores based on the overlapping between a text
	 * and a given taxonomy.
	 * 
	 * @param query
	...
	public int getTaxoScore(String query, String snapshot) {
		...
		} catch (Exception e) { // if OpenNLP model is unavailable, use
								// different tokenizer
	...
	/**
	 * It loads a serialized taxonomy in .dat format and serializes it into a
	 * much more readable XML format.
	 * 
	 * @param taxonomyPath
	 * @param taxonomyXML_Path
	 * 
	 * 
	 *            public void convertDatToXML(String taxonomyXML_Path,
	 *            TaxonomySerializer taxo) { XStream xStream = new XStream();
	 *            FileHandler fileHandler = new FileHandler(); try {
	 *            fileHandler.writeToTextFile(xStream.toXML(taxo),
	 *            taxonomyXML_Path, false); } catch (Exception e) {
	 *            e.printStackTrace(); LOG.info(e.toString()); }
	 * 
	 *            }
	 * 
	 *            public void xmlWork() { TaxoQuerySnapshotMatcher matcher = new
	 *            TaxoQuerySnapshotMatcher(
	 *            "src/test/resources/taxonomies/irs_domTaxo.dat"); XStream
	 *            xStream = new XStream(); FileHandler fileHandler = new
	 *            FileHandler(); matcher.taxo = (TaxonomySerializer)
	 *            xStream.fromXML(fileHandler
	...
	static public void main(String[] args) {
		...
		System.out.println("The score is: " + matcher.getTaxoScore(
