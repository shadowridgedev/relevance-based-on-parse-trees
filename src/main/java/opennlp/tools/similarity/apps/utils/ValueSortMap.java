...
public class ValueSortMap {
	 ...
	 */
	public static <K, V> LinkedHashMap<K, V> sortMapByValue(Map<K, V> inMap, Comparator<V> comparator) {
		return sortMapByValue(inMap, comparator, null);
	}

	/**
	 * This method returns the new LinkedHashMap sorted with values for passed
	 * ascendingOrder. If null values exist they will be put in the last for
	 * true value of ascendingOrder or will be put on top of the returned
	 * LinkedHashMap for false value of ascendingOrder. If there are duplicate
	 * values they will come together at the values ordering order but ordering
	 ...
	 * @return LinkedHashMap Sorted new LinkedHashMap
	 */
	public static <K, V> LinkedHashMap<K, V> sortMapByValue(Map<K, V> inMap, boolean ascendingOrder) {
	 ...
	 * LinkedHashMap. If there are duplicate values they will come together at
	 ...
	 * @return LinkedHashMap Sorted new LinkedHashMap
	 */
	private static <K, V> LinkedHashMap<K, V> sortMapByValue(Map<K, V> inMap, Comparator<V> comparator,
