...
public class SpeechRecognitionResultsProcessor /* extends BingWebQueryRunner */ {
	 ...
	 * syntactically similar to this phrase, then we conclude that this phrase
	 * is meaningful (makes sense, someone have said something similar. If
	 * search results ate not similar to this phrase, we conclude that the
	 * phrase is meaningless (does not make sense, nobody has ever said
	 * something like that)
	 * 
	 * @param hits
	 ...
	 */
	private double calculateTotalMatchScoreForHits(List<HitBase> hits, String searchQuery) {
	...
	public static void main(String[] args) {
		...
		proc.runSearchAndScoreMeaningfulness(
				Arrays.asList(new String[] { "meeting with alex at you for not to come over to 8 pm",
						"meeting with alex at you for not to come over to eat",
						"meeting with alex at il fornaio tomorrow to 8 pm" }));

		proc.runSearchAndScoreMeaningfulness(Arrays.asList(new String[] { "remember to buy milk tomorrow for details",
				"remember to buy milk tomorrow from trader joes", "remember to buy milk tomorrow from 3 to jones",
				"remember to buy milk tomorrow for for details", "remember to buy milk tomorrow from third to joes",
		...
		proc.runSearchAndScoreMeaningfulness(Arrays.asList(
				new String[] { "I'm off tomorrow to shop at trader joes", "number to get milk tomorrow trader joes",
						"number 2 finals tomorrow from trader joes", "number 2 finals tomorrow trader joes",
						"number to buy move tomorrow from trader joes", "number to buy move tomorrow trader joes",
						"define move tomorrow from trader joes", "define move tomorrow trader joes", }));
	}
