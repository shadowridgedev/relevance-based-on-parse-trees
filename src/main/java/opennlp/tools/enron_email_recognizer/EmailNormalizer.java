...
public class EmailNormalizer {
	...
	public static final String[] headers = new String[] { "Message-ID:", "Date:", "From:", "To:", "Subject:",
			"Mime-Version:", "Content-T", "X-From:", "X-To:", "X-cc:", "X-bcc:", "X-Folder:", "X-Origin:", "X-FileName",
			"cc:", "----", };
