...
public class FormalConcept {
	...
	Set<Integer> parents;
	Set<Integer> extent;
	double intLogStabilityBottom = 0, intLogStabilityUp = 0, separation = 0, probability = 0, blS_Jaa = 0,
			blS_SMCaa = 0, blS_Jam = 0, blS_SMCam = 0, blS_Jmm = 0, blS_Jma = 0, blS_SMCma = 0, blS_SMCmm = 0, blCV = 0,
			blCFC = 0, blCU = 0, blP = 0;

	double cohAvgJ = 0, cohMinJ = 0, cohAvgSMC = 0, cohMinSMC = 0;
	...
	public void printConceptFull() {
		...
		System.out.println("Concept childs:" + childs);
		System.out.format(
				"Prob.  blSaaJ   blSaaSMC blSmaJ   blSmmJ   blSmaSMC  blSamJ   blSamSMC  blCV     blCFC    blCU     blP      separ.\n");
		System.out.format("%5.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f\n",
				probability, blS_Jaa, blS_SMCaa, blS_Jma, blS_Jmm, blS_SMCma, blS_Jam, blS_SMCam, blCV, blCFC, blCU,
				blP, separation);
