...
/**
 * Responsible to sending e-mails trough a gmail smtp server. It will be
 * extended to handle arbitrary smtp servers.
 * 
 * @author GaDo
 *
 */
public class EmailSender {
	...
	public boolean sendMail(String smtp, String user, String pass, InternetAddress from, InternetAddress[] to,
			InternetAddress[] cc, InternetAddress[] bcc, String subject, String body, String file) throws Exception {
	...
	private boolean validateAddress(InternetAddress from, InternetAddress[] to, InternetAddress[] cc,
			InternetAddress[] bcc) {
		boolean correct = true;
		try {
	...
	public static void main(String[] args) {
		...
		try {
			s.sendMail("smtp.rambler.ru", "boris_galitsky@rambler.ru", "b06g93",
					new InternetAddress("bgalitsky@hotmail.com"),
					new InternetAddress[] { new InternetAddress("bgalitsky@hotmail.com") }, new InternetAddress[] {},
					new InternetAddress[] {}, "Generated content for you", "body", null);
