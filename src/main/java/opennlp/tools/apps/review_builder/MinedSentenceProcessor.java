...
public class MinedSentenceProcessor {
	private static final Logger log = Logger.getLogger("opennlp.tools.apps.review_builder.MinedSentenceProcessor");
	...
	public static String acceptableMinedSentence(String sent) {
		...
		if (sentTry.indexOf("click here") > -1 || sentTry.indexOf(" wikip") > -1 || sentTry.indexOf("copyright") > -1
				...
				|| sentTry.indexOf("permission is granted") > -1 || sentTry.indexOf("[edit") > -1
				|| sentTry.indexOf("edit categories") > -1 || sentTry.indexOf("free license") > -1
				|| sentTry.indexOf("permission is granted") > -1 || sentTry.indexOf("under the terms") > -1
				|| sentTry.indexOf("rights reserved") > -1 || sentTry.indexOf("wikipedia") > -1
				|| sentTry.endsWith("the") || sentTry.endsWith("the.") || sentTry.startsWith("below")
				...
				|| sentTry.startsWith("fax") || sentTry.startsWith("write") || sentTry.startsWith("email")
				|| sentTry.indexOf("conditions") > -1 || sentTry.indexOf("chat live") > -1 || sentTry.startsWith("we ")
				...
				|| sentTry.indexOf("credit card") > -1

				|| sentTry.indexOf("storeshop") > -1 || sentTry.startsWith("find") || sentTry.startsWith("shop")
				|| sentTry.startsWith("unlimited") || sentTry.indexOf("for a limited time") > -1
				|| sentTry.indexOf("prime members") > -1 || sentTry.indexOf("amazon members") > -1
				|| sentTry.indexOf("unlimited free") > -1 || sentTry.indexOf("shipping") > -1
				|| sentTry.startsWith("amazon")
				// not a script text
				|| sentTry.indexOf("document.body") > -1 || sentTry.indexOf(" var ") > -1
				|| sentTry.indexOf("search suggestions") > -1 || sentTry.startsWith("Search")

		)
			return null;

		// Millions of Amazon Prime members enjoy instant videos, free Kindle
		// books and unlimited free two-day shipping.
		...
		sent = sent.replace('[', ' ').replace(']', ' ').replace("_should_find_orig_", "").replace(".   .", ". ")
				...
				.replace("VIDEO:", " ").replace("Video:", " ").replace("no comments", " ").replace("  ", " ")
				.replace("  ", " ").replace("(more.)", "").replace("more.", "").replace("<more>", "")
