...
public class MachineTranslationWrapper {
	...
	public String rePhrase(String sentence) {
		...
		if (!(inverseTransl.indexOf("NO QUERY SPECIFIED") > -1) && !(inverseTransl.indexOf("INVALID LANGUAGE") > -1)
				&& !(inverseTransl.indexOf("MYMEMORY WARNING") > -1))
	...
	public static void main(String[] args) {
		...
		System.out.println(rePhraser
				.translate("I went to the nearest bookstore to buy a book written by my friend and his aunt", "en|ru"));

		System.out.println(
				rePhraser.rePhrase("I went to the nearest bookstore to buy a book written by my friend and his aunt"));
