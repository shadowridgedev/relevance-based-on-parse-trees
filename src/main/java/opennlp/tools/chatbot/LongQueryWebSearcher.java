...
public class LongQueryWebSearcher {
	private static Logger LOG = Logger.getLogger("opennlp.tools.chatbot.LongQueryWebSearcher");
	...
	public List<ChatIterationResult> searchProductQuery(String queryOrig) {
		...
		try {
			...
			String content = pFetcher.fetchOrigHTML(amazonUrl); // ">Technical
																// Details</h2>","\">See
																// More</\""
			...
			if (areaWithAttrValues != null) {
				...
				if (aVareas == null || aVareas.length < 2)
					// <tr><td class="label">Size</td><td class="value">16-Inch
					// Small/Medium</td></tr>
			...
			if (areaWithAttrValues != null) {
				// <li><b>Domestic Shipping: </b>Item can be shipped within
				// U.S.</li>
