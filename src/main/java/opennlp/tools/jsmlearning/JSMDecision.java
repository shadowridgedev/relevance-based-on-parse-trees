...
public class JSMDecision {
	...
	List<List<List<ParseTreeChunk>>> posHypotheses, negHypotheses;
	List<List<List<ParseTreeChunk>>> posIntersectionsUnderNeg, negIntersectionsUnderPos;
	...
	public void setPosIntersectionsUnderNeg(List<List<List<ParseTreeChunk>>> posIntersectionsUnderNeg) {
	...
	public void setNegIntersectionsUnderPos(List<List<List<ParseTreeChunk>>> negIntersectionsUnderPos) {
		this.negIntersectionsUnderPos = negIntersectionsUnderPos;
	}

	public JSMDecision(String keywordClassName, Boolean bPositiveClass, List<List<List<ParseTreeChunk>>> posHypotheses,
			List<List<List<ParseTreeChunk>>> negHypotheses, List<List<List<ParseTreeChunk>>> posIntersectionsUnderNeg,
