...
public class MyMatcher {
	...
	public List<String> readFile() throws Exception {
		 ...
		 * 
		 * al.add(line); } br.close();
		 */
		String content = FileUtils
				.readFileToString(new File("/Users/bgalitsky/Documents/relevance-based-on-parse-trees/fidelity.txt"));
	...
	public void checkLinguisticScores(String q, List<String> aList) throws Exception { // convert
																						// query
																						// into
																						// list
																						// of
